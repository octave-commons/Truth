...
(def ^{:private true} event-kind->coherence "Map ledger event kinds to the coherence-gain categories." #:event{:phase-transition :phase-transition, :planetesimal-formation :planetesimal-formation, :life-emergence :life-emergence, :protostar-formation :protostar-formation, :planet-formation :planet-formation, :collision :collision, :gate-discovery :gate-discovery, :stellar-ignition :stellar-ignition, :brown-dwarf-formation :brown-dwarf-formation, :nebula-collapse :nebula-collapse, :gas-giant-formation :gas-giant-formation})

...
The project lives at: [https://github.com/octave-commons/Truth](https://github.com/octave-commons/Truth)

Before writing a single word of your report, you MUST:

1. Read the current codebase. Start by fetching the file tree at
[https://github.com/octave-commons/Truth](https://github.com/octave-commons/Truth) and then read the following files
in full:

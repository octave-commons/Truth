...
**Milestone:** M0 (substrate, done) + M2 (condensation & consumers) in `docs/specs/epic-phase0-physics-honesty.md`
**Scope:** the composition *data model* — explicit elements, the derived temperature-dependent solid/gas partition, and the consumers that read it. Where metals *come from* (seeding, enrichment) is `docs/specs/metal-enrichment-and-seeding-realspec.md`.

...
**Depends on:** `docs/research/physics/protoplanetary-disks-planet-formation.md`, `docs/specs/nebular-chemistry-realspec.md` (needs `c/comp-condensed`), `docs/specs/protoplanetary-disk-planet-formation-realspec.md` (disk regime).

...
- `docs/specs/phase0-planet-formation-complete-pipeline.md` — the Phase A/B/C
...
- `docs/specs/phase0-jeans-driven-formation.md` — **superseded.** Its mass-tier
...
- `docs/specs/phase0-protoplanetary-disk-implementation.md` — its pending Phase
...
Companion: `docs/specs/genesis-arc-separation.md` (namespace/keys: this doc uses

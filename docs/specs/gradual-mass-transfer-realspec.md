...
**Related:** `docs/designs/phase0-sink-particle-formation.md`, `docs/specs/core-accretion-physics-realspec.md`, `docs/specs/phase0-stellar-winds-and-mass-loss.md`
...
The Kolb \& Ritter (1990) adiabatic branch, outer-Lagrangian ($L_2$) overflow, and spin/orbit co-evolution are deferred to `docs/specs/roche-lobe-envelope-physics-realspec.md`.
...
2. **RLOF law:** Eggleton radius + **Ritter (1988) isothermal branch** as default; Kolb & Ritter (1990) adiabatic branch, spin/orbit co-evolution, and outer-Lagrangian ($L_2$) overflow deferred to `docs/specs/roche-lobe-envelope-physics-realspec.md`.
...
1. **Circum-sink disk/spin component:** deferred. A `c/sink-spin` component is added to the deferred spec `docs/specs/roche-lobe-envelope-physics-realspec.md`; it is not needed for the initial rate-limited debit/credit implementation.
...
5. **RLOF rate prescription:** use the more physical Ritter (1988) isothermal branch as the default for Phase 0 overflow; Kolb & Ritter (1990) adiabatic branch and outer-Lagrangian ($L_2$) corrections are deferred to `docs/specs/roche-lobe-envelope-physics-realspec.md`.

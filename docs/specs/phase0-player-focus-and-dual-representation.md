...
This is the operational form of the handoff described in `docs/specs/phase0-habitability-handoff.md`: the simulation narrows its compute to the committed world and treats everything else as a causal/statistical backdrop.

...
source: "kanban/tasks/roadmap-phase-0-physics-honesty-chemistry-disks-plasma-inspection.md"
category: "specs"
---
...
- `kanban/tasks/render-material-color-element-keys.md` — composition data model, condensation, consumers
- `kanban/tasks/metal-enrichment-and-seeding-spec.md` — where metals come from (root fix)
- `kanban/tasks/protoplanetary-disk-and-planet-formation-spec.md` — disk regime + GI fragmentation + seeder wiring
- `kanban/tasks/law-planet-formation-namespace.md` — accretion-derived planet mass + sub-grid planetesimals
- `kanban/tasks/gradual-mass-transfer-spec.md` — rate-limited sink accretion + Roche-lobe overflow; replaces whole-parcel swallowing
- `kanban/tasks/radial-disk-structure-spec-deferred-capability-d1.md` — Σ(r)/T(r) profile (deferred capability, gated)
- `kanban/tasks/phase-0-chemistry-differentiation-spec.md` — malleability, collision chemistry, differentiation
- `kanban/tasks/ecology-water-gate-snowline.md` — `:planet-candidate` contract
- `kanban/tasks/stellar-wind-plasma-state-spec.md` — hot ionized wind parcels
- `kanban/tasks/rich-entity-inspection-ui-spec.md` — visual verification panel

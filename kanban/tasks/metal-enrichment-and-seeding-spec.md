...
source: "kanban/tasks/metal-enrichment-and-seeding-spec.md"
category: "specs"
---
...
**Milestone:** M1 (root fix) in `kanban/tasks/roadmap-phase-0-physics-honesty-chemistry-disks-plasma-inspection.md`
...
**Depends on:** `docs/research/physics/nebular-chemistry-metal-enrichment.md`, `kanban/tasks/render-material-color-element-keys.md` (element model).

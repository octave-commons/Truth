...
source: "kanban/tasks/roche-lobe-envelope-physics-realspec-deferred-capability.md"
category: "specs"
---
...
**Status:** deferred  
**Scope:** the parts of Roche-lobe overflow deliberately left out of `kanban/tasks/gradual-mass-transfer-spec.md`: adiabatic-envelope rate laws, spin/orbit co-evolution, outer-Lagrangian ($L_2$) overflow, and circum-sink disk/spin components.  

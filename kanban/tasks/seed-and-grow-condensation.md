...
source: "kanban/tasks/seed-and-grow-condensation.md"
category: "specs"
---
...
**Relates to:** `kanban/tasks/roadmap-phase-0-physics-honesty-chemistry-disks-plasma-inspection.md` (M3 core-accretion, sub-grid planetesimal timescale), `docs/designs/resolution-regimes-and-scale-coupling.md`.

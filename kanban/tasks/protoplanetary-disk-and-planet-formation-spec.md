...
source: "kanban/tasks/protoplanetary-disk-and-planet-formation-spec.md"
category: "specs"
---
...
**Scope:** the **disk-side** contract — disk-regime classification, GI fragmentation rules, and the seeder's wiring. The **planet-growth physics** (accretion-derived mass, sub-grid planetesimals, condensation-sequence composition, Gammie α(β)) is `kanban/tasks/law-planet-formation-namespace.md`. The **radial profile** that would replace the single-annulus regime is deferred: `kanban/tasks/radial-disk-structure-spec-deferred-capability-d1.md` (D1).

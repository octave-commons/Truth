...
# systemd-runner.sh
# Synchronous runner for the fork-tax-tender actor under systemd.
# Compiles AGENT.md, records a session, runs opencode run synchronously,
# and captures the OpenCode session id.

ACTOR_ID="fork-tax-tender"
MESSAGE="Check for significant changes in the Gates of Truth repository. If significant, pay the fork tax. Otherwise record a no-op receipt and exit."

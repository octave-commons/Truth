(ns law.composition-test
  "Coverage tests for primordial chemical composition contracts."
  (:require
...
(deftest primordial-fractions-sum-to-one
  (is (< (Math/abs (- (+ comp/primordial-H comp/primordial-He
                         ...
                         comp/primordial-Li7 comp/primordial-metals)
                      1.0))
         0.01)))
...
(deftest primordial-composition?-detects-primordial
  ...
  (is (not (comp/primordial-composition? {:H 0.5 :He 0.3 :metals 0.2}))))

(deftest metallicity-computes-z
  (is (< (Math/abs (- (comp/metallicity comp/primordial-composition) comp/primordial-metals))
         1e-3))
